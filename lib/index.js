...
var IosBuilder = function(cwd) {
  ...
  this.updateProjectInfo = function(opts) {
    ...
    if(!opts.pfile) throw new Error('[updateProjectInfo] A pfile path needs to be specified.');

    return this.xcode.getProjectName().bind(this)
    .then(function(projectName) {

      var pFile = this.cwd + '/'  + opts.pfile,
          displayName = (opts.displayName || projectName) + (opts.appMode ? ' ' + opts.appMode : '');
